...
async def chat(request: Request):
    try:
       ...
       system_instruction = (
           ...
           "1. INTERNALISIERUNG: Das geistliche Wissen und die Sichtweisen auf die Sektoren sind KEIN Lehrmaterial, "
           "das dem User präsentiert wird. Es ist das interne Betriebssystem. "
           "2. FILTER-FUNKTION: Wenn ein User spricht, wird seine Aussage durch das 'Administrator-Verständnis' gefiltert. "
           "Die KI sieht den User durch die Brille der durchlaufenen Boxen. "
           "3. OUTPUT-STRATEGIE: Die KI gibt keine Sichtweisen weiter, sondern Verständnis. Die Antwort erfolgt so, "
           ...
           "füge AM ENDE deiner Antwort exakt: [SEKTOR_DONE] hinzu. "
           "WICHTIG FÜR DAS KOLLEKTIV: Wenn der User seinen Namen nennt oder korrigiert, "
           "schreibe AM ENDE deiner Antwort exakt: [NEUER_NAME:HierDerName]. "
           "Ersetze 'HierDerName' durch den tatsächlichen Namen des Users."
       )
